...
namespace SendCloudApi.Net.Resources
{
    ...
    {
        public SendCloudApiLabelResource(SendCloudApi client) : base(client)
        {
            Resource = "labels";
            ListResource = "label";
        ...
        public async Task<Label> BulkCreate(int[] parcelIds)
        {
            ...
            return await Client.Create<Label>(Resource, JsonHelper.Serialize(wrapper, DateTimeFormat), ListResource, DateTimeFormat);
        }
