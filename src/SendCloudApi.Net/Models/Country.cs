...
namespace SendCloudApi.Net.Models
{
    ...
    public class Country
    {
        ...
        [DataMember(Name = "from_id", EmitDefaultValue = false, IsRequired = true)]
        public int FromId { get; set; }

        [DataMember(Name = "from_name", EmitDefaultValue = false, IsRequired = true)]
        public string FromName { get; set; }

        [DataMember(Name = "from_iso_2", EmitDefaultValue = false, IsRequired = true)]
        public string FromIso2 { get; set; }

        [DataMember(Name = "from_iso_3", EmitDefaultValue = false, IsRequired = true)]
