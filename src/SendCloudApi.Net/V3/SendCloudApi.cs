...
namespace SendCloudApi.Net.V3
{
    ...
    {
		public readonly SendCloudApiAddressResource Address;
        ...
        {
            Address = new SendCloudApiAddressResource(this);
        ...
        protected override string GetErrorMessage(string responseBody)
        {
            ...
            var message = string.Join("\n", result.Errors.Select(x => string.Format("{0} {1} {2} ({3})", x.Field, x.Message, x.Detail, x.Code)));
            return message;
        }
    }
}
